...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ruler = __webpack_require__(3);
	...
	_jquery2.default.fn.getRuler = function () {
	  var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

	  var ops = Object.assign(defaultOptions, options);
	  var perWidth = parseFloat(ops.perWidth);
	  var thick = ops.thick * ops.ratio;
	  var ops2 = Object.assign({}, ops, {
	    // 标尺起始坐标
	    originX: ops.startX,
	    originY: ops.startY,
	    //每一小格的宽度
	  ...
	  var ruler = this.data('ruler') ? this.data('ruler') : new _ruler2.default(this, ops2);
	  return ruler;
	};
...
/***/ function(module, exports) {
	...
	var RulerFactory = function () {
	  function RulerFactory(options) {
	    _classCallCheck(this, RulerFactory);
	...
	exports.RulerFactory = RulerFactory;
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./ruler.sass\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	...
	var Ruler = function () {
	  ...
	  _createClass(Ruler, [{
	    ...
	    value: function _init() {
	      ...
	      //如果已经初始化,则需要先销毁原有实例
	      this.factory = new _utils.RulerFactory({
	        ratio: this.ratio,
	    ...
	    value: function _addRuler() {
	      ...
	      var rulerBox = (0, _jquery2.default)('<div class="mb-ruler"></div>');
	      ...
	      //水平对齐线container
	      var horDiv = (0, _jquery2.default)('<div class="hor-div"></div>');
	      horDiv.css('marginLeft', this.thick / this.ratio);
	      rulerBox.prepend(horDiv);
	      this.horDiv = horDiv;

	      //竖直对齐线container
	      var verDiv = (0, _jquery2.default)('<div class="ver-div"></div>');
	      ...
	      horRuler.on('click', function (event) {
	        ...
	        (0, _jquery2.default)(document.body).trigger('setAlignLine', {
	    ...
	    key: '_addCurrentValue',
	    value: function _addCurrentValue() {
	      this._addHorCurrentValue();
	      this._addVerCurrentValue();
	    }
	  }, {
	    key: '_addHorCurrentValue',
	    value: function _addHorCurrentValue() {
	      var factory = this.factory;
	    ...
	    key: '_addVerCurrentValue',
	    value: function _addVerCurrentValue() {
	      var factory = this.factory;
	    ...
	    key: '_drawAlignLine',
	    value: function _drawAlignLine() {
	      this._drawHorLine();
	      this._drawVerLine();
	    }
	  }, {
	    key: '_addAlignLine',
	    value: function _addAlignLine() {
	      _jquery2.default.each(this.horLineValue, function (index, value) {
	        this._addHorLine(value);
	      }.bind(this));

	      _jquery2.default.each(this.verLineValue, function (index, value) {
	        this._addVerLine(value);
	      }.bind(this));
	    }
	    //新增一条对齐线
	    ...
	    key: '_addHorLine',
	    value: function _addHorLine(value) {
	      ...
	      horLine.on('mousedown', function (e) {
	        ...
	        (0, _jquery2.default)(document).one('mouseup', function (event) {
	          event.preventDefault();
	    ...
	    key: '_addVerLine',
	    value: function _addVerLine(value) {
	    ...
	    key: '_setPosition',
	    value: function _setPosition(startX, startY) {
	    ...
	    key: 'setSelect',
	    value: function setSelect(x, y, width, height) {
	      this.shadow = {
	        x: x,
	        y: y,
	        width: width,
	    ...
	    key: '_destroyHorLine',
	    value: function _destroyHorLine() {
	      //解绑每个对齐线的时间
	      _jquery2.default.each(this.horLine, function (index, elem) {
	    ...
	    key: '_destroyVerLine',
	    value: function _destroyVerLine() {
	      //解绑每个对齐线的事件
	      _jquery2.default.each(this.verLine, function (index, elem) {
	        elem.find('span').off('click');
	        elem.off('mouseover');
	        elem.off('mouseleave');
	        // elem.off('mousedown')
