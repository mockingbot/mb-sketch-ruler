...
/***/ function(module, exports, __webpack_require__) {
	...
	function initRuler() {
	  var posX = parseInt((0, _jquery2.default)('#posX').val());
	  var posY = parseInt((0, _jquery2.default)('#posY').val());
	  var thick = parseInt((0, _jquery2.default)('#thick').val());
	  var fgColor = (0, _jquery2.default)('#fgColor').val();
	  var bgColor = (0, _jquery2.default)('#bgColor').val();
	  var shadowColor = (0, _jquery2.default)('#shadowColor').val();
	  var font = (0, _jquery2.default)('#font').val();
	  var fontColor = (0, _jquery2.default)('#fontColor').val();
	  var ratio = parseInt((0, _jquery2.default)('#ratio').val());
	  var perWidth = (0, _jquery2.default)('#perWidth').val();
	  var ruler = (0, _jquery2.default)('#screens').getRuler({
	    startX: -240, //posX,
	    // -240
	    startY: posY,
	    // -100
	  ...
	  (0, _jquery2.default)('#screens').css({
	    overflow: 'scroll'
	...
	function setSelect() {
	  var x = parseInt((0, _jquery2.default)('#x').val());
	  var y = parseInt((0, _jquery2.default)('#y').val());
	  var width = parseInt((0, _jquery2.default)('#width').val());
	  var height = parseInt((0, _jquery2.default)('#height').val());
	  var ruler = (0, _jquery2.default)('#screens').getRuler();
	...
	function bindFunction() {
	  (0, _jquery2.default)('#setSelect').on('click', setSelect);
	  (0, _jquery2.default)('#initRuler').on('click', initRuler);
	  (0, _jquery2.default)('#removeRuler').on('click', removeRuler);
	  (0, _jquery2.default)('#clearShadow').on('click', clearShadow);
	}
	...
	(0, _jquery2.default)(function () {
	  ...
	  for (var i = 0; i < 200; i++) {
	    ...
	    var color = (0, _utils.getRandomColor)();
	    html += '<div class="cube" style="background:' + color + ';left:' + left + 'px;top:' + top + 'px;width:' + width + 'px;height:' + height + 'px"></div>';
	    // var div = $('div').width()
	  }
	  (0, _jquery2.default)('#screens .screen_container').append(html);

	  var screensStyle = (0, _jquery2.default)('#screens').get(0).getBoundingClientRect();
	  var conTop = screensStyle.top;
	  var conLeft = screensStyle.left;
	  // console.log(conTop, conLeft)
	  //点击测试
	  (0, _jquery2.default)('#screens').on('click', '.cube', function (e) {
	    var ruler = (0, _jquery2.default)('#screens').getRuler();
	  ...
	  (0, _jquery2.default)(document.body).on('setAlignLine', function (event, position) {
	    event.preventDefault();
