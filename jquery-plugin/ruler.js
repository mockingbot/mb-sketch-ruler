		...
		_drawVerRuler : function(posY, height, needShadow){
	        ...
	        for (var i = startY; i < startY + this.height / this.ratio; i += 10) {
	            ...
	            if (i % 100 === 0) {
	                ...
	                //回复刚刚保存的状态
	                ctx.restore();
	                ctx.lineTo(0, i * this.ratio)

	            } else { //绘制短刻度
	                ctx.lineTo(this.thick * 2 / 3, i * this.ratio)
	            }
	            ctx.stroke();
	        }
	        ctx.closePath();
